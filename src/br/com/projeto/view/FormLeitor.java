...
public class FormLeitor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnXlsExport = new javax.swing.JButton();
        btnXlsImport = new javax.swing.JButton();
        ...
        txtMaxEmprestimos = new javax.swing.JFormattedTextField();
        ...
        btnXlsExport.setText("Exportar para XLSX");
        btnXlsExport.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnXlsExportActionPerformed(evt);
            }
        });

        btnXlsImport.setText("Importar dados de arquivo XLSX");
        btnXlsImport.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnXlsImportActionPerformed(evt);
            }
        });
        ...
        tabConsultaUsuariosLayout.setHorizontalGroup(
            ...
            .addGroup(tabConsultaUsuariosLayout.createSequentialGroup()
                ...
                .addComponent(btnXlsExport)
                .addGap(18, 18, 18)
                .addComponent(btnXlsImport)
                .addContainerGap())
            .addGroup(tabConsultaUsuariosLayout.createSequentialGroup()
                .addGap(25, 25, 25)
        ...
        boxTipo.setDebugGraphicsOptions(javax.swing.DebugGraphics.NONE_OPTION);
        ...
        try {
            txtMaxEmprestimos.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("##")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }
            ...
            .addGroup(tabCadastroLayout.createSequentialGroup()
                ...
                .addGroup(tabCadastroLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(tabCadastroLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(tabCadastroLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(boxTipo, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel20))
                        .addGap(0, 0, Short.MAX_VALUE))))
        );
        ...
        btnNovo1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/iconfinder_Door_enter_entrance_exit_leave_logout_out_quit_4831032.png"))); // NOI18N
        btnNovo1.setText("FECHAR");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(tabbedFrame, javax.swing.GroupLayout.PREFERRED_SIZE, 826, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        try {
            obj.setEmprestmax(Integer.parseInt(txtMaxEmprestimos.getText().trim()));
        } catch (Exception e) {
            txtMaxEmprestimos.setText("");
        }
        ...
        if (txtNome.getText().isEmpty() || txtCelular.getText().isEmpty() || txtRg.getText().isEmpty() || txtCep.getText().isEmpty() || txtEndereco.getText().isEmpty() || txtMaxEmprestimos.getText().isEmpty() || boxUf.getSelectedIndex() == -1 || boxTipo.getSelectedIndex() == -1) {
            JOptionPane.showMessageDialog(null, "Campos  com * são de preenchimento obrigatório!");
        } else {
            UsuarioDao dao = new UsuarioDao();
    ...
    private void btnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirActionPerformed
        ...
        String msgNome = txtNome.getText().toUpperCase();
        String msgCurso = txtCurso.getText().toUpperCase();
        String msgAcesso = (String.valueOf(boxTipo.getSelectedItem()).toUpperCase());
        ...
        if (filename.endsWith(".jpg") || filename.endsWith(".JPG") || filename.endsWith(".png") || filename.endsWith(".PNG") || filename.endsWith(".jpeg")) {
            ...
            if (result == JFileChooser.APPROVE_OPTION) {
                ...
                try {
                    ...
                    ImageIO.write(image, "jpg", new File("C:\\Librography\\images\\usuarios\\" + txtId.getText()));
    ...
    private void btnXlsExportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXlsExportActionPerformed
        Utilitarios util = new Utilitarios();
        JFileChooser fc = new JFileChooser();
        fc.setSelectedFile(new File("Usuarios"));
        int option = fc.showSaveDialog(FormLeitor.this);
                ...
                if (ext.equals(".xlsx")) {
                    switch (util.getOS()) {
                        case WINDOWS:
                            ...
                            break;
                        case MAC:
                            file = path + "/" + filename;//estava \\ no windows /(ver)
                            break;
                    }
                } else {
                    switch (util.getOS()) {
                        case WINDOWS:
                            ...
                            break;
                        case MAC:
                            file = path + "/" + filename + ".xlsx";//estava \\ no windows /(ver)
                            break;
                    }
                    file = path + "/" + filename + ".xlsx";//aqui tambem
                }
                util.toExcel(tabelaUsuario, new File(file));
                JOptionPane.showMessageDialog(null, "Arquivo Salvo com sucesso em " + file + "!");
            } catch (IOException ex) {
                Logger.getLogger(FormLeitor.class.getName()).log(Level.SEVERE, null, ex);
            }
        }    
    }//GEN-LAST:event_btnXlsExportActionPerformed
    private void btnXlsImportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXlsImportActionPerformed
        ...
        if (filename.endsWith(".xlsx") || filename.endsWith(".XLSX")) {
            FileNameExtensionFilter filter = new FileNameExtensionFilter("*.table", "xlsx");
            fileChooser.addChoosableFileFilter(filter);
            if (returnValue == JFileChooser.APPROVE_OPTION) {
                String path = selectedFile.getAbsolutePath();
                try {
                    try {
                        userDao.importaUsuariosXls(path);
            ...
            JOptionPane.showMessageDialog(null, "Selecione o Arquivo de nome: 'Usuarios.xlsx'");
        }
    }//GEN-LAST:event_btnXlsImportActionPerformed
    ...
    private javax.swing.JButton btnXlsExport;
    private javax.swing.JButton btnXlsImport;
    ...
    private javax.swing.JFormattedTextField txtMaxEmprestimos;
